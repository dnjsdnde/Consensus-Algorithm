...
#include "pol_dilithium_5_sha256_TPS.h"
#include <stdbool.h>
#include <stdio.h>
#include "stdlib.h"
#include <string.h>
...
// TODO: signature 실패하는 이유 알아내기
// TODO: message, signature, public_key, secret_key 등 뒤에 '\0'을 공통적으로 붙이거나 하기
...
// ===================================================================================================================================================
    ...
    PoLNode::HandleRead(Ptr<Socket> socket) {
        ...
        double executionTime = double(network.end - network.start) / CLOCKS_PER_SEC;
    ...
    PoLNode::PoLMine(Block::BlockHeader header, Block previousBlock) {
        ...
        cout << "header.txs : " << header.txs.size() << endl;
    ...
    PoLNode::VerifyTxs(Blockchain chain) {
        for (int i = 0; i < chain.GetBlockchainHeight(); i++) {
            // cout << "chain.blocks[i].header.txs.size(): " << chain.blocks[i].header.txs.size() << endl;
