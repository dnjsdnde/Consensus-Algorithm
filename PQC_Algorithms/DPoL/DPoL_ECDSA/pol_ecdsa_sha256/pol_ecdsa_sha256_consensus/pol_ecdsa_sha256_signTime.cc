...
#include "pol_ecdsa_sha256_signTime.h"
#include <stdbool.h>
#include <stdio.h>
#include "stdlib.h"
#include <string.h>
...
// ===================================================================================================================================================
    ...
    PoLNode::GenerateTx(void) {
        ...
        string sign = SignTx(tx.txItem, m_ecKey);

        tx.signature = network.String2Bytes(sign);
    ...
    PoLNode::SignTx(vector<uint8_t> txItem, EC_KEY * ec_key) {
        ...
        cout << "SignTx: " << network.signTime / (GetNode()->GetId() + 1) << endl;
    ...
    PoLNode::VerifyTx(vector<uint8_t> txItem, vector<uint8_t> sign, vector<uint8_t> ecKey) {
        ...
        clock_t start = clock();
        for (int i = 0; i < network.numTx; i++) {
            ECDSA_do_verify(hash, size, signature, ec_key);
        }
        clock_t end = clock();
