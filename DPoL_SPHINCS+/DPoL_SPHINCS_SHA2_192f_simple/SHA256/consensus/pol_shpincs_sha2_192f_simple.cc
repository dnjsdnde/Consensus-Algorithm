...
#include "pol_shpincs_sha2_192f_simple.h"
#include <stdbool.h>
#include <stdio.h>
#include "stdlib.h"
#include <string.h>
...
// ===================================================================================================================================================
    ...
    int
    Tx::GetTxSize() {
        return this->txItem.size() + this->pk.size() + this->sign.size();
    }
...
// ===================================================================================================================================================
    ...
    PoLNode::StartApplication(void) {
        cout << "PoL shpincs_sha2_192f_simple" << endl;
    ...
    PoLNode::SendChain(Blockchain chain) {
        ...
        cout << "chain.SerializeChain().first : " << chain.SerializeChain().first.size() << endl;
    ...
    //     m_miningId = Simulator::Schedule (Seconds (1), &PoW::RunPoW, this, nonce, mineTime); // 채굴 시작
    // }
    ...
    PoLNode::SignTx(vector<uint8_t> txItem, vector<uint8_t> sk) {
        ...
        uint8_t public_key[OQS_SIG_sphincs_sha2_192f_simple_length_public_key];
        network.Bytes2Array(m_pk, public_key);
        ...
        if (rc != OQS_SUCCESS) { 
            cout << "SignTx :  Failed" << endl;
        }
        else { 
            // cout << "SignTx :  Successed" << endl; 
        }


        // signature[signature_len] = '\0';
        vector<uint8_t> sig = network.Array2Bytes(signature, signature_len);        
        // durlrk
        return sig;
    }
