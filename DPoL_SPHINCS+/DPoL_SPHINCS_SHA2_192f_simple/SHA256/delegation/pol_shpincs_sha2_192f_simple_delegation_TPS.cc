...
#include "pol_shpincs_sha2_192f_simple_delegation_TPS.h"
#include <stdbool.h>
#include <stdio.h>
#include "stdlib.h"
#include <string.h>
    ...
    Tx::DeserializeTx(string packet) {
        ...
        do {
            ...
            switch(offset) {
                ...
                // 'k'ey
                case 'k':
                    this->pk.push_back(packet[i]);
                    continue;
                // 's'ign
                case 's':
                    this->sign.push_back(packet[i]);
                    continue;
            }
        } while (i != packet.size());
    }
...
// ===================================================================================================================================================
    ...
    PoLNode::StartApplication(void) {
        ...
        network.start = clock();
        Simulator::Schedule(Seconds(0), &PoLNode::Vote, this);                                          // Schedule NewRound function to generate block
    ...
    PoLNode::Vote(void) {
        ...
        vote.sign = SignTx(vote.txItem, m_sk);
        vote.pk = m_pk;
